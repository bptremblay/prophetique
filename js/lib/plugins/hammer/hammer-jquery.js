...
YUI().add('hammer-jquery', function(Y) {
        ...
        Hammer.event = {
            ...
            onTouch: function onTouch(element, eventType, handler) {
                ...
                // mouseevents and pointerEvents (win8)
                    ...
                    this.bindDom(element, Hammer.EVENT_TYPES[eventType], function(ev) {
                        ...
                        if(ev.type.match(/down|move/i) && (ev.which === 1 || (ev.pointerType && ev.pointerType == ev.MSPOINTER_TYPE_TOUCH))) {
                            touchdown = true;
                        }
            ...
            collectEventData: function collectEventData(element, eventType, ev) {
                ...
                return {
                    ...
                    timestamp: ev.timestamp || new Date().getTime(),
                    // for IE
                    target: ev.target,
                    touches: touches,
                    eventType: eventType,
        ...
        Hammer.gesture = {
            ...
            startDetect: function startDetect(inst, ev) {
                ...
                this.current = {
                    ...
                    startEvent: Hammer.utils.extend({}, ev),
